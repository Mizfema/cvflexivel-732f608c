 ...
 * nas secções (D1) como nos itens dentro delas (D2). */
const DRAG_HANDLE_VISIBILITY_CLASS =
 ...
 * para a nova ordem do array de itens. */
function useItemDragAndDrop(ids: string[], onReorder: (newIds: string[]) => void) {
...
function ItemSummary({ primary, secondary }: { primary?: string; secondary?: string }) {
