...
3. Hook de bloqueio: em src/lib/access-control.server.ts, no topo de checkAndRecordUsage/requireUsageAllowed, se o userId autenticado tiver suspensão ativa → devolver erro com código distinto ACCOUNT_SUSPENDED e mensagem "A tua conta foi suspensa. Contacta cvelite@gmail.com." — NUNCA a mensagem genérica de limite.
